...
export function Footer() {
  ...
  return (
    <footer className="relative border-t-2 border-primary bg-[hsl(var(--foreground))] text-[hsl(var(--background))] mt-16 lg:mt-24 overflow-hidden">
      ...
      <div className="relative z-10">
        <section className="px-4 sm:px-8 pt-16 pb-12">
          <div className="mx-auto max-w-7xl grid md:grid-cols-2 lg:grid-cols-2 gap-10 items-center">
            <div>
              <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold leading-[0.95]">
                Siap melayani.
                <br />
            ...
            <div className="flex flex-col gap-4">
              <p className="font-body text-base text-[hsl(var(--background))/70] max-w-md">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link
                  ...
                  className="btn-pill border border-[hsl(var(--background))/20 text-[hsl(var(--background))] hover:bg-[hsl(var(--background))]/10"
                >
                  Sampaikan Aspirasi
                </Link>
              </div>
        ...
        <section className="px-4 sm:px-8 py-14">
          <div className="mx-auto max-w-7xl grid gap-10 md:grid-cols-2 lg:grid-cols-5">
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="font-ui text-xs text-[hsl(var(--background))/60]">
                    {district} · {regency}
                  </div>
                </div>
              </div>
              <p className="font-body text-sm text-[hsl(var(--background))/70] leading-relaxed mb-5 max-w-sm">
                Website resmi pemerintah desa untuk pelayanan, transparansi, dan partisipasi warga.
              </p>
              <ul className="space-y-2.5 text-sm text-[hsl(var(--background))/70]">
              ...
              <div className="flex gap-2 mt-5">
                {[
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="h-11 w-11 rounded-full border border-[hsl(var(--background))/20] hover:border-primary hover:bg-primary hover:text-primary-foreground flex items-center justify-center transition-all focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                    aria-label={`Ikuti ${villageName} di ${label}`}
                  >
                ...
                <ul className="space-y-2.5">
                  {col.links.map((l) => (
                    <li key={l.to}>
                      <Link
                        to={l.to}
                        className="font-ui text-sm text-[hsl(var(--background))/70] hover:text-primary transition-colors"
                      >
                        {l.label}
                      </Link>
                    </li>
        ...
        <div className="px-4 sm:px-8 py-5">
          <div className="mx-auto max-w-7xl flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[hsl(var(--background))/60] font-ui">
            <div>© 2026 {villageName}. Semua Hak Dilindungi.</div>
            <div className="flex gap-5">
              <a href="#" aria-label="Kebijakan Privasi">
                Kebijakan Privasi
              </a>
              <a href="#" aria-label="Syarat dan Ketentuan">
                Syarat & Ketentuan
              </a>
              <a href="#" aria-label="Peta Situs">
                Peta Situs
              </a>
            </div>
          </div>
