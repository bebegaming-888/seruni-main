...
export function ContactSection() {
  return (
    <section id="kontak" className="py-20 sm:py-28 px-4 sm:px-8 bg-cream">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 rounded-3xl overflow-hidden border border-border h-[420px] relative">
            ...
            <div className="absolute top-4 left-4 right-4 sm:right-auto sm:max-w-xs rounded-2xl bg-card p-4 shadow-card">
              ...
              <div className="font-display font-bold text-ink">Kantor Desa Seruni Mumbul</div>
              <div className="font-body text-xs text-muted-foreground mt-1">{VILLAGE.address}</div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="rounded-3xl bg-card border border-border p-6 space-y-3">
              ...
              >
                <div className="h-10 w-10 rounded-full bg-cream group-hover:bg-primary group-hover:text-primary-foreground flex items-center justify-center">
                  <Phone className="h-4 w-4" />
                </div>
                <div>
                  <div className="font-ui text-xs text-muted-foreground">Telepon</div>
                  <div className="font-ui font-semibold text-ink group-hover:text-primary">
                    {VILLAGE.phone}
                  </div>
                </div>
              </a>
              ...
              <div className="flex items-start gap-3 pt-3 border-t border-border">
                ...
                <div>
                  ...
                  <div className="font-ui text-sm text-ink leading-snug">{VILLAGE.address}</div>
                </div>
              </div>
            </div>
