...
export const SURAT_MASTER: Record<string, SuratMaster> = {
  ...
  KK_BARU: {
    ...
    syarat: [
      ...
      "Keteranganhilang dari kepolisian (jika hilang)",
    ],
  ...
  SK_PENGHASILAN: {
    ...
    category: "Sosial & Ekonomi",
    wewenang: true,
    description: "Untuk KUR (Kredit Usaha Rakyat) dan lainnya.",
    eta: "1 hari kerja",
    fields: [
      { key: "penghasilan", label: "Penghasilan per Bulan (Rp)", type: "number", required: true },
      { key: "sumber_penghasilan", label: "Sumber Penghasilan", type: "text", required: true },
      { key: "keperluan", label: "Keperluan", type: "textarea", required: true, colSpan: 2 },
    ],
  ...
  SKU: {
    ...
    fields: [
      ...
      { key: "alamat_usaha", label: "Alamat Usaha", type: "textarea", required: true, colSpan: 2 },
  ...
  SP_IMB: {
    ...
    category: "Surat Umum & Lainnya",
    wewenang: true,
    description: "PENGGANTI Surat Pengantar IMB/PBG (bukan wewenang).",
    eta: "1 hari kerja",
    fields: [
      {
        key: "lokasi_bangunan",
